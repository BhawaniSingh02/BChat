  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {selectionMode ? (
        ...
        <div className="h-[58px] px-3 md:px-4 border-b border-slate-800/60 bg-gradient-to-r from-slate-950 via-slate-900 to-teal-950 flex items-center gap-2 md:gap-3 shadow-[0_14px_34px_rgba(15,23,42,0.28)] z-10">
          {onBack && (
            <button
              onClick={onBack}
