...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-green-700 to-teal-700 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl flex bg-white rounded-3xl shadow-2xl overflow-hidden min-h-[520px]">
        {/* Left panel — branding */}
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 md:p-12">
          <div className="w-full max-w-sm">
            ...
            <p className="text-gray-500 text-sm mb-7">Sign in to continue chatting</p>
